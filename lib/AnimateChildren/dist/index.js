...
import { flatMap, isPortal, cloneWithMergedRef, filterNodeByKey, createProp, clone } from "./helper";
//╭─────────────────────────────────────────────────╮
//│ # Main                                          │
//╰─────────────────────────────────────────────────╯
export function AnimateChildren({ children }) {
    ...
    useEffect(() => {
        ...
        const newRender = flatMap(children, child => {
    ...
    useLayoutEffect(() => {
        ...
        rendered.forEach(child => {
            ...
            if (!prev)
                return; // Can't animate if rect is not saved
...
function useRefObject(defaultObj) {
    ...
    return ref.current; // directly return .current to avoid ref.current. everywhere.
}
//╭─────────────────────────────────────────────────╮
//│ Helper                                          │
//╰─────────────────────────────────────────────────╯
